		...
		<table class="table table-bordered table-striped">
				...
				<tr>
					...
					<td class="text-center">
						...
						<% if(session.getAttribute("type") != null){ if((Integer)session.getAttribute("type") == 1) {%><a href="add_drug.jsp?id=<%=drug.getId()%>"><span class="glyphicon glyphicon-pencil"></span></a><% } %>
				...
				<tr>
					...
					<td class="text-center">
						...
						<% if(session.getAttribute("type") != null){ if((Integer)session.getAttribute("type") == 1) {%><a href="add_drug.jsp?id=<%=searchedDrug.getId()%>"><span class="glyphicon glyphicon-pencil"></span></a><% } %>
