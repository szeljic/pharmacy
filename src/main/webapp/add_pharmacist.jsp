		...
		<div class="row">
			...
			%>
				...
				<br />
					...
					<form method="post" onsubmit="return checkForm();" action="<% if(!edit) { %>AddPharmacistServlet <% } else { %> EditPharmacistServlet <% } %>">
						...
						<%
							if(edit){ %>
							<div class="form-group">
								<input type="hidden" name="id" value="<% id = request.getParameter("id"); %> <%=id%>">
							</div>
