		...
		<table class="table table-bordered table-striped">
				...
				<tr>
					...
					<td class="text-center">
						<a href="add_pharmacist.jsp?id=<%=user.getId()%>"><span class="glyphicon glyphicon-pencil"></span></a>
						<a href="RemovePharmacistServlet?id=<%=user.getId()%>"><span class="glyphicon glyphicon-remove"></span></a>
					</td>
				</tr>
