		...
		<table class="table table-bordered table-striped">
				...
				<tr>
					...
					<td class="text-center">
						<% if(!order.isStatus()) { %>
							<a href="ApproveOrderServlet?id=<%=order.getId()%>&page=unresponse"><span class="glyphicon glyphicon-ok"></span></a>
							<a href="DenyOrderServlet?id=<%=order.getId()%>&page=unresponse"><span class="glyphicon glyphicon-remove"></span></a>
						<% } %>
					</td>
				</tr>
